...
import "./SpecialStudentQuizList.css";

function SpecialStudentQuizList() {
  ...
  return (
    <div className="special-student-quiz">
      {/* Header */}
      <header className="special-header">
        ...
        <h1>My Quizzes</h1>
        <p>View available quizzes, attempt them, and track your results</p>
        ...
        {loading ? (
          ...
          quizzes.map((quiz) => {
            ...
            if (startTime && now < startTime) {
              ...
              onClick = () => navigate(`/specialstudent/quiz-result/${quiz._id}`);
            ...
            return (
              <div key={quiz._id} className="quiz-card">
                ...
                <div className="quiz-details">
                  {quiz.startTime && (
                    <p>
                      <Clock size={16} /> <b>Starts:</b> {formatLocalDate(quiz.startTime)}
                    </p>
                  )}
                  {quiz.endTime && (
                    <p>
                      <Clock size={16} /> <b>Ends:</b> {formatLocalDate(quiz.endTime)}
                    </p>
                  )}
                </div>
...
export default SpecialStudentQuizList;
